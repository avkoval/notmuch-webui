...
**** WORKING Display message screen [%]
     :LOGBOOK:
     CLOCK: [2025-03-20 Thu 07:57]
     - State "WORKING"    from              [2025-03-20 Thu 07:55]
     :END:

 - [ ] add tag to pprint/debug json
 - [ ] format all parts nicely
 - [ ] add signals to show/hide parts of content
 - [ ] add top navigation part
