...
**** WORKING Display message screen [27%]
     :LOGBOOK:
...
***** WORKING add signals to show/hide parts of content
      :LOGBOOK:
      CLOCK: [2025-04-03 Thu 08:30]
 ...
 - [ ] use content, check responsive rendering
 - [ ] add signals to hide/show based on message N + part N
 - [ ] use nice icons to do this (triangle?)
